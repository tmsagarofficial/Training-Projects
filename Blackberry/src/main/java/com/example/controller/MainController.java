...
public class MainController {
	...
	public Devices blackberry() {
		...
		Device d1 = new Device(1, "Black-1", "Smart Phone--from-1");
	    Device d2 = new Device(2, "Black-2", "Smart Phone--from-1");
	    Device d3 = new Device(3, "Black-3", "Feature Phone--from-1");
	    Device d4 = new Device(4, "Black-4", "Tablet--from-1");
	    Device d5 = new Device(5, "Black-5", "Smart Watch--from-1");
